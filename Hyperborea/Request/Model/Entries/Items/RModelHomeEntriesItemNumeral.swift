...
class RModelHomeEntriesItemNumeral:RModelHomeEntriesItem
{
    ...
    required init(json:Any)
    {
        ...
        let title:String = NSLocalizedString("RModelHomeEntriesItemNumeral_title", comment:"")
        let senses:RModelHomeEntriesSenses = RModelHomeEntriesSenses(json:json)
        let numeral:RModelHomeEntriesNumeral = RModelHomeEntriesNumeral(json:json)
        let titleString:NSAttributedString = NSAttributedString(
            string:title,
            attributes:attributes)
        let sensesString:NSAttributedString = senses.attributedString()
        let numeralString:NSAttributedString = numeral.attributedString()
